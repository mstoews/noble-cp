        ...
        <div class="flex items-start justify-between" >
            <div class="text-lg font-medium tracking-tight leading-6 truncate dark:text-gray-100">{{caption()}}</div>            
                <div class="ml-2 -mt-2 -mr-3">
                    @switch(chart()){
                        @case ('1') { <span class="e-icons e-chart-donut text-6xl dark:text-red-100"></span> }            
                        ...
                        @case ('15' ){ <span class="e-icons e-chart-with-legend-keys text-6xl dark:text-purple-100"></span> }
