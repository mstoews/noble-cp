...
export const loadFundsSuccess = createAction(LOAD_FUNDS_SUCCESS, props<{ list: IFunds[] }>());
export const loadFundsFailure = createAction(LOAD_FUNDS_FAILURE, props<{ error: string }>());

export const deleteFunds = createAction(DELETE_FUNDS, props<{ id: number }>());
export const deleteFundsSuccess = createAction(DELETE_FUNDS_SUCCESS, props<{ id: number }>());
...
export const getFunds = createAction(GET_FUNDS, props<{ id: number }>());
