...
const mods = [MatProgressSpinnerModule, GridMenubarStandaloneComponent, GLGridComponent];
...
export class DistributedTbComponent implements OnInit {
  ...
  columns = [
        ...
        { field: 'child',       headerText: 'Acct', isPrimaryKey: true, isIdentity: true, width: 90 },
        { field: 'account_description', visible: false, headerText: 'Description', width: 100,  displayAsCheckbox: true},
        ...
        { field: 'pd',      visible: false, headerText: 'Prd', width: 100 },
        { field: 'prd_year',visible: false, headerText: 'Yr', width: 100  }                       
    ];
